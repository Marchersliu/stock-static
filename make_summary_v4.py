...
font_cell = ImageFont.truetype(FONT_PATH, 12)
...
# 总高度：标题+总结+表格
IMG_H = 50 + SUMMARY_H + 40 + TABLE_H + 50
...
# ===== 1. 标题 =====
draw.text((MARGIN, 25), "📋 协作总结 — 喷涂厂项目时间轴", fill=C['title'], font=font_title)
...
# 表格小标题
draw.text((MARGIN, table_y - 25), "📊 项目时间轴（XDR & Darfon）", fill=C['title'], font=font_header)
