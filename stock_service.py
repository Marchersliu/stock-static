...
# ===================== 股票配置 =====================
# 2026-05-11 更新：8只持仓标的
HOLDINGS = [
    {"code": "688485.SH", "name": "九州一轨", "shares": 19569, "cost": 46.70, "target": "80/100", "stop": 52.0, "hero": True},
    {"code": "300819.SZ", "name": "聚杰微纤", "shares": 0, "cost": 82.00, "target": "90-100", "stop": 75.0, "hero": False},
    {"code": "002484.SZ", "name": "江海股份", "shares": 0, "cost": 0, "target": "48-52", "stop": 38.0, "hero": False},
    {"code": "603063.SH", "name": "禾望电气", "shares": 0, "cost": 0, "target": "35", "stop": 30.0, "hero": False},
    {"code": "603828.SH", "name": "ST利达", "shares": 0, "cost": 0, "target": "7-8", "stop": 4.8, "hero": False},
    {"code": "000034.SZ", "name": "神州数码", "shares": 0, "cost": 0, "target": "35-40", "stop": 28.0, "hero": False},
    {"code": "002364.SZ", "name": "中恒电气", "shares": 0, "cost": 0, "target": "12-13", "stop": 9.5, "hero": False},
    {"code": "002439.SZ", "name": "启明星辰", "shares": 0, "cost": 0, "target": "25-30", "stop": 18.0, "hero": False},
]

WATCHLIST = [
    {"code": "300433.SZ", "name": "蓝思科技", "target": "35-40", "stop": 25.0, "rec": 30.0},
]
...
# 板块映射（用于板块资金流向监控）
# 2026-05-11 全面梳理：8只持仓标的 + 产业链映射
STOCK_SECTORS = {
    '688485.SH': {'sector': '轨交设备', 'sector_code': None, 'related': ['半导体/芯片', 'AI芯片散热', '国产替代']},
    '300819.SZ': {'sector': '纺织服饰·电子布', 'sector_code': None, 'related': ['电子元件', 'PCB', '消费电子', '固态电池']},
    '603828.SH': {'sector': '建筑装饰', 'sector_code': None, 'related': ['基建', '装修装饰', '装配式']},
    '603063.SH': {'sector': '电气设备', 'sector_code': None, 'related': ['风电', '光伏', '储能', '新能源']},
    '000034.SZ': {'sector': 'IT分销·信创', 'sector_code': None, 'related': ['云计算', '国产替代', '数据中心', '华为']},
    ...
    '300433.SZ': {'sector': '消费电子·AI算力', 'sector_code': None, 'related': ['消费电子', '玻璃', '液冷', '服务器机柜', '英伟达供应链', 'MGX', 'Rubin']},
}
...
STOCK_KEYWORDS = {
    ...
    '300819.SZ': {
        'name': '聚杰微纤',
        'keywords': ['聚杰微纤', '300819', '超细纤维', '电子布', 'PCB', '纺织', '消费电子', '固态电池', '郎溪', '根银科技'],
        'industry': ['纺织服饰', '电子材料'],
        'level': 'holding'
    },
    '002484.SZ': {
    ...
    '603063.SH': {
        'name': '禾望电气',
        'keywords': ['禾望电气', '603063', '禾望', '风电变流器', '光伏逆变器', '储能', '新能源', '电气设备'],
        'industry': ['电气设备', '新能源'],
        'level': 'holding'
    },
    '603828.SH': {
        'name': 'ST利达',
        'keywords': ['ST利达', '柯利达', '603828', '建筑装饰', '幕墙', '装修', '装配式', '光伏建筑', 'BIPV'],
        'industry': ['建筑装饰', '装修装饰'],
        'level': 'holding'
    },
    '000034.SZ': {
        'name': '神州数码',
        'keywords': ['神州数码', '000034', '神州', 'IT分销', '云计算', '信创', '华为', '鲲鹏', '昇腾', '国产替代'],
        'industry': ['IT服务', '信创', '云计算'],
        'level': 'holding'
    },
    '002364.SZ': {
        'name': '中恒电气',
    ...
    '300433.SZ': {
        'name': '蓝思科技',
        'keywords': ['蓝思科技', '300433', '蓝思', 'Lens', '消费电子', '玻璃', '元拾科技', 'PMG', '裴美高', '液冷', '服务器机柜', '英伟达', 'NVDA', 'RVL', 'MGX', 'Rubin'],
        'industry': ['消费电子', 'AI算力', '液冷', '英伟达供应链'],
        'level': 'watchlist'
    },
}
...
def analyze_news_relevance(item):
    ...
    INDUSTRY_KWS_DETAILED = {
        ...
        '电气设备/新能源': ['风电', '光伏', '逆变器', '变流器', '储能', '新能源', '电气设备', '电网', '电力设备'],
        '电容/电子元件': ['电容', '超级电容', '铝电解', '薄膜电容', 'MLCC', '电子元件', '被动元件'],
        '电源/HVDC': ['HVDC', '高压直流', '数据中心电源', '巴拿马电源', 'UPS', '服务器电源'],
        '纺织服饰/电子布': ['电子布', '超细纤维', '纺织', '面料', 'PCB基材', '覆铜板', 'CCL', '玻纤布'],
        '建筑装饰': ['建筑装饰', '幕墙', '装修', '装配式', 'BIPV', '光伏建筑'],
        'IT分销/信创': ['IT分销', '信创', '云计算', '国产替代', '鲲鹏', '昇腾', '华为生态', '服务器分销'],
    }
    matched_industries = []
    ...
    if matched_customers:
        ...
        customer_map = {
            ...
            '华为': ['002484.SZ', '688485.SH', '002364.SZ', '300819.SZ', '000034.SZ'],  # 江海、九州、中恒、聚杰、神州
            ...
            '国铁集团': ['688485.SH'],
            '铁路局': ['688485.SH'],
            '国家电网': ['002364.SZ', '002484.SZ', '603063.SH'],
            '南方电网': ['002364.SZ', '002484.SZ', '603063.SH'],
            '宁德时代': ['002484.SZ'],
            '比亚迪': ['002484.SZ', '603063.SH'],
            '特斯拉': ['002484.SZ', '603063.SH'],
            '丰田': ['300819.SZ'],
            'Toyota': ['300819.SZ'],
            '上汽': ['300819.SZ'],
            '上海汽车': ['300819.SZ'],
    ...
    if matched_us:
        ...
        # 关联美股映射股票
        us_stock_map = {
            'NVIDIA': ['002484.SZ', '002364.SZ', '300819.SZ'], '英伟达': ['002484.SZ', '002364.SZ', '300819.SZ'],
            'AMD': ['002484.SZ', '002439.SZ'], 'Intel': ['002439.SZ', '688485.SH'],
            '台积电': ['002484.SZ'], 'TSMC': ['002484.SZ'],
            'ASML': ['688485.SH'],
            '半导体指数': ['002484.SZ', '688485.SH', '300819.SZ'],
            '芯片股': ['002484.SZ', '688485.SH', '300819.SZ'],
            'SOX': ['002484.SZ', '688485.SH', '300819.SZ'],
            '消费电子': ['300819.SZ'],
            'Apple': ['300819.SZ'], '苹果': ['300819.SZ'],
        }
...
def fetch_moneyflow():
    ...
    Tushare moneyflow 的 amount 字段单位是千元（千元人民币），
    这里转换为万元后返回，便于看板直接显示。
    ...
    try:
        for code in ALL_STOCK_CODES:
            ...
            if df is not None and not df.empty:
                ...
                # 千元 → 万元
                main_net = round(((buy_lg + buy_elg) - (sell_lg + sell_elg)) / 10, 2)
                main_total = (buy_lg + sell_lg + buy_elg + sell_elg) / 10
        ...
        if df is not None and not df.empty:
            ...
            for _, row in df.iterrows():
                ...
                basics[code] = {
                    ...
                    'volume_ratio': round(row.get('dv_ratio', 0), 2),  # 量比
                    'pe': pe,
...
def fetch_history_changes():
    ...
    注意: Tushare daily接口返回的数据按trade_date降序排列(从新到旧)，
    需要先按升序排序后再计算
    """
    try:
        ...
        for code in ALL_STOCK_CODES:
            if len(trade_dates) >= 8:
                ...
                if hist is not None and len(hist) >= 2:
                    # Tushare返回按trade_date降序，需升序排列
                    hist = hist.sort_values('trade_date', ascending=True)
...
def fetch_sector_fund_flow_akshare():
    ...
    try:
        ...
        SECTOR_KEYWORDS = {
            ...
            '半导体/芯片': ['半导体', '芯片', '集成电路', '金刚石', '散热', '真空泵', 'SiC', '碳化硅'],
            # 产业链映射
            ...
            '华为算力': ['华为', '海思', '昇腾', '鲲鹏', '鸿蒙'],
            '第三代半导体': ['SiC', '碳化硅', '氮化镓', 'GaN', '第三代半导体'],
            '功率器件': ['功率器件', 'IGBT', 'MOSFET', 'SiC器件', '充电桩'],
            '国产替代': ['国产替代', '自主可控', '卡脖子'],
            '信创': ['信创', '国产软件', '国产化'],
        }
...
class DashboardHandler(http.server.SimpleHTTPRequestHandler):
    ...
    def _send_json(self, data):
        # 将 NaN/Inf 替换为 None，避免 JSON 序列化出现裸 NaN 导致前端解析失败
        def sanitize(obj):
            ...
            if isinstance(obj, float) and (obj != obj or obj == float('inf') or obj == float('-inf')):
                return None
            return obj
        body = json.dumps(sanitize(data), ensure_ascii=False, default=str)
