...
# 板块映射（用于板块资金流向监控）
STOCK_SECTORS = {
    '688485.SH': {'sector': '轨交设备', 'sector_code': None},
    '002158.SZ': {'sector': '通用设备', 'sector_code': None},
    '002439.SZ': {'sector': '网络安全', 'sector_code': None},
    '688679.SH': {'sector': '环保', 'sector_code': None},
...
STOCK_KEYWORDS = {
    ...
    '688679.SH': {
        'name': '通源环境',
        'keywords': ['通源环境', '688679', '环保', '液冷', '散热', '数据中心', '浸没式液冷', '王晓东', '旭创', '王伟修'],
        'industry': ['环保', '液冷', '数据中心'],
        'level': 'watchlist'
    },
    '603828.SH': {
        'name': 'ST柯利达',
        'keywords': ['ST柯利达', '603828', '柯利达', '英众智能', '英众', '重组', 'ST', '摘帽', '建筑装饰', '装修'],
        'industry': ['建筑装饰', '重组概念'],
        'level': 'watchlist'
    },
    '301027.SZ': {
        'name': '华蓝集团',
        'keywords': ['华蓝集团', '301027', '华蓝', '设计院', '光伏', '算力', '元禾控股', '算电协同'],
        'industry': ['工程设计', '光伏'],
        'level': 'watchlist'
    },
    '301125.SZ': {
        'name': '腾亚精工',
        'keywords': ['腾亚精工', '301125', '腾亚', '电动工具', '园林机械', '割草机', '泳池机器人', '机器人关节'],
        'industry': ['通用设备', '机器人'],
        'level': 'watchlist'
    },
}
