...
# 提取 PREMARKET_NEWS 数组（支持 const/let/var）
m = re.search(r'(?:const|let|var)\s+PREMARKET_NEWS\s*=\s*(\[.*?\]);', html, re.DOTALL)
if not m:
...
# 股票代码映射（从新闻标题提取）
CODE_MAP = {
    '九州一轨': '688485.SH', '汉钟精机': '002158.SZ',
    '聚杰微纤': '300819.SZ', 'ST利达': '603828.SH', '柯利达': '603828.SH',
    '江海股份': '002484.SZ', '中恒电气': '002364.SZ', '启明星辰': '002439.SZ',
    '禾望电气': '603063.SH', '神州数码': '000034.SZ',
}
